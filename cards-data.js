...
window.CARDS = [
  ...
  {
    id: 'ajcharaporn-chanchaew',
    name: 'Ajcharaporn Chanchaew',
    nickname: null,
    title: 'บจ.ศรีกรุงโบรคเกอร์',
    company: 'Ajcharaporn Chanchaew',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'anan-kongsawangchai',
    name: 'Anan Kongsawangchai',
    nickname: null,
    title: 'A.M.F.(THAILAND) CO.,LTD. (Head Office)',
    company: 'A.M.F.(THAILAND) CO.,LTD. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'anucha-chantasuk',
    name: 'Anucha Chantasuk',
    nickname: null,
    title: 'ห้างหุ้นส่วนจำกัด โปรเกรซ กลาส (สำนักงานใหญ่)',
    company: 'Anucha Chantasuk',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'anunya-chandawan',
    name: 'Anunya Chandawan',
    nickname: null,
    title: 'บริษัท โปร คลีนนิ่ง เซ็นเตอร์ จำกัด (สำนักงานใหญ่)',
    company: 'Anunya Chandawan',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'chatchai-lertplakorn',
    name: 'Chatchai Lertplakorn',
    nickname: null,
    title: 'บริษัท บลูแกส จำกัด (สำนักงานใหญ่)',
    company: 'Chatchai Lertplakorn',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'chatree-boonnithititkul',
    name: 'Chatree Boonnithititkul',
    nickname: null,
    title: 'SEANG NGARM GROUP(2535) CO.,LTD. (HEAD OFFICE)',
    company: 'SEANG NGARM GROUP(2535) CO.,LTD. (HEAD OFFICE)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'eakpong-wongasa',
    name: 'Eakpong Wongasa',
    nickname: null,
    title: 'บริษัท แกรนด์เฟอร์นิช กรุ๊ป จำกัด (สำนักงานใหญ่)',
    company: 'Eakpong Wongasa',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'kannapat-pantong',
    name: 'Kannapat Pantong',
    nickname: null,
    title: 'บริษัท ซัคซีดด์ ดีไซน์ จำกัด (สำนักงานใหญ่)',
    company: 'Kannapat Pantong',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'kanyakorn-tiemsri',
    name: 'Kanyakorn Tiemsri',
    nickname: null,
    title: 'T&K Win Trading Co.,Ltd',
    company: 'T&K Win Trading Co.,Ltd',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'kittipong-sirinawakul',
    name: 'Kittipong Sirinawakul',
    nickname: null,
    title: 'Aek Arun Production House Co., Ltd. (Head Office)',
    company: 'Aek Arun Production House Co., Ltd. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'komsun-sriyabhandha',
    name: 'Komsun Sriyabhandha',
    nickname: null,
    title: null,
    company: 'Komsun Sriyabhandha',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  },
  {
    ...
    name: 'Napat Surasmo',
    nickname: null,
    title: 'บริษัท วัชรพลหินอ่อน 2000 จำกัด (สำนักงานใหญ่)',
    company: 'Napat Surasmo',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'narudee-kittinanthapanya',
    name: 'Narudee Kittinanthapanya',
    nickname: null,
    title: 'บริษัท ซอสทูซัคเซส จำกัด (สำนักงานใหญ่)',
    company: 'Narudee Kittinanthapanya',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'natthapon-khamchoo',
    name: 'Natthapon Khamchoo',
    nickname: null,
    title: 'บริษัท นันทวิชญ์ โยธาการ จำกัด (สำนักงานใหญ่)',
    company: 'Natthapon Khamchoo',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'nattiya-chimchavee',
    name: 'Nattiya Chimchavee',
    nickname: null,
    title: 'Marketing To Success co.,ltd. (Head Office)',
    company: 'Marketing To Success co.,ltd. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'ninlada-suwiwatchai',
    name: 'Ninlada Suwiwatchai',
    nickname: null,
    title: 'ห้างหุ้นส่วนจำกัด ต.วิวัฒน์ค้าวัสดุภัณฑ์ (1987) (สำนักงานใหญ่)',
    company: 'Ninlada Suwiwatchai',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'nunthapak-rodboonpha',
    name: 'Nunthapak Rodboonpha',
    nickname: null,
    title: 'บริษัท วิน อินคัม จำกัด (สำนักงานใหญ่)',
    company: 'Win Income Co., Ltd.',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'peerapong-chaingoentra',
    name: 'Peerapong Chaingoentra',
    nickname: null,
    title: 'I.D.C.IDEACOMPLETE CO.,LTD.',
    company: 'I.D.C.IDEACOMPLETE CO.,LTD.',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'phantarabhorn-wachanachusit',
    name: 'Phantarabhorn Wachanachusit',
    nickname: null,
    title: 'บริษัท เอไอ เทคโนเวชั่น จำกัด (สำนักงานใหญ่)',
    company: 'Phantarabhorn Wachanachusit',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'pipat-thanaudomkul',
    name: 'Pipat Thanaudomkul',
    nickname: null,
    title: 'SAMNAKKOTMAI PIPAT AND ASSOCIATES CO.,LTD. (HEAD OFFICE)',
    company: 'SAMNAKKOTMAI PIPAT AND ASSOCIATES CO.,LTD. (HEAD OFFICE)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'porames-sawasdee',
    name: 'Porames Sawasdee',
    nickname: null,
    title: 'Zebolar Network & Communication Co.,Ltd. (Head Office)',
    company: 'Zebolar Network & Communication Co.,Ltd. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'ravikorn-chunhasri',
    name: 'Ravikorn Chunhasri',
    nickname: null,
    title: null,
    company: 'Ravikorn Chunhasri',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'raweewan-bunsri',
    name: 'Raweewan Bunsri',
    nickname: null,
    title: 'บริษัท อาร์แอนด์อาร์ ร่ำรวย จำกัด (สำนักงานใหญ่)',
    company: 'Raweewan Bunsri',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'sireepattra-srihamool',
    name: 'Sireepattra Srihamool',
    nickname: null,
    title: 'HOUSEKI THE DECORATOR CO.,LTD. (HEAD OFFICE)',
    company: 'HOUSEKI THE DECORATOR CO.,LTD. (HEAD OFFICE)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'somprasong-pisansorakit',
    name: 'Somprasong Pisansorakit',
    nickname: null,
    title: 'บริษัท แล็บ อาร์ต ดีไซต์ จำกัด (สำนักงานใหญ่)',
    company: 'www.labartdesign.co.th',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'suphawinee-arunothai',
    name: 'Suphawinee Arunothai',
    nickname: null,
    title: 'บริษัทผู้ผลิต, บริษัทนำเข้า–ส่งออกสินค้า, ตัวแทนจำหน่ายเครื่องจักร, หรือที่ปรึกษาด้านการค้าระหว่างประเทศ Manufacturers, import-export companies, machinery distributors, or international trade consultants.',
    company: 'YNN Global Logistics Co., Ltd. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'suteera-intarapasert',
    name: 'Suteera Intarapasert',
    nickname: null,
    title: 'ห้างหุ้นส่วนจำกัด มองไกล กรุ๊ป แอนด์ ดีไซน์ (สำนักงานใหญ่)',
    company: 'Suteera Intarapasert',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'teerayut-temram',
    name: 'Teerayut Temram',
    nickname: null,
    title: 'บริษัท ธีครีเอทีฟ เอ็นจิเนียริ่ง จำกัด (สำนักงานใหญ่)',
    company: 'Teerayut Temram',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'thanatdon-phudithiranyasakul',
    name: 'Thanatdon Phudithiranyasakul',
    nickname: null,
    title: 'บริษัท ธน 69 จำกัด (สำนักงานใหญ่)',
    company: 'Thanatdon Phudithiranyasakul',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'uthen-sitthipongporn',
    name: 'Uthen Sitthipongporn',
    nickname: null,
    title: 'บริษัท จัสเอ็มอี เอ็นจิเนียริ่ง จำกัด (สำนักงานใหญ่)',
    company: 'Uthen Sitthipongporn',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'waranya-chuenjai',
    name: 'Waranya Chuenjai',
    nickname: null,
    title: 'Drive iGency Co., Ltd. (Head Office)',
    company: 'Drive iGency Co., Ltd. (Head Office)',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
  ...
  {
    id: 'wuttipong-terdsathabun',
    name: 'Wuttipong Terdsathabun',
    nickname: null,
    title: 'บริษัท อีเอ็ม ซัพพลาย แอนด์ เซอร์วิส จำกัด (สำนักงานใหญ่)',
    company: 'www.emss.co.th',
    description: null,
    tags: [],
    tel: null,
    telLink: null,
